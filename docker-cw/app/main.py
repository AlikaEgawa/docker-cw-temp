...
def pref_ui(value):
    ...
    if value == "栃木県":
        url = "prefecture_id=9"
    if value == "群馬県":
        url = "prefecture_id=10"
    if value == "埼玉県":
        url = "prefecture_id=11"
    if value == "千葉県":
        url = "prefecture_id=12"
    if value == "東京都":
        url = "prefecture_id=13"
    if value == "神奈川県":
        url = "prefecture_id=14"
    if value == "新潟県":
        url = "prefecture_id=15"
    if value == "富山県":
        url = "prefecture_id=16"
    if value == "石川県":
        url = "prefecture_id=17"
    if value == "福井県":
        url = "prefecture_id=18"
    if value == "山梨県":
        url = "prefecture_id=19"
    if value == "長野県":
        url = "prefecture_id=20"
    if value == "岐阜県":
        url = "prefecture_id=21"
    if value == "静岡県":
        url = "prefecture_id=22"
    if value == "愛知県":
        url = "prefecture_id=23"
    if value == "三重県":
        url = "prefecture_id=24"
    if value == "滋賀県":
        url = "prefecture_id=25"
    if value == "京都府":
        url = "prefecture_id=26"
    if value == "大阪府":
        url = "prefecture_id=27"
    if value == "兵庫県":
        url = "prefecture_id=28"
    if value == "奈良県":
        url = "prefecture_id=29"
    if value == "和歌山県":
        url = "prefecture_id=30"
    if value == "鳥取県":
        url = "prefecture_id=31"
    if value == "島根県":
        url = "prefecture_id=32"
    if value == "岡山県":
        url = "prefecture_id=33"
    if value == "広島県":
        url = "prefecture_id=34"
    if value == "山口県":
        url = "prefecture_id=35"
    if value == "徳島県":
        url = "prefecture_id=36"
    if value == "香川県":
        url = "prefecture_id=37"
    if value == "愛媛県":
        url = "prefecture_id=38"
    if value == "高知県":
        url = "prefecture_id=39"
    if value == "福岡県":
        url = "prefecture_id=40"
    if value == "佐賀県":
        url = "prefecture_id=41"
    if value == "長崎県":
        url = "prefecture_id=42"
    if value == "熊本県":
        url = "prefecture_id=43"
    if value == "大分県":
        url = "prefecture_id=44"
    if value == "宮崎県":
        url = "prefecture_id=45"
    if value == "鹿児島県":
        url = "prefecture_id=46"
    if value == "沖縄県":
        url = "prefecture_id=47"
    return url
...
def score_ui(value):
    if value == "":
        url = None
    if value == "3.0以上":
        url = "average_score_as_employee=3"
    if value == "4.0以上":
        url = "average_score_as_empsloyee=4"
    if value == "5.0":
        url = "average_score_as_employee=5"
    return url
